...
import 'package:new_digivote/signup_second.dart';
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: (){
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => signupprsnlpage(email: emailController.text, password: passwordController.text)));
        },
