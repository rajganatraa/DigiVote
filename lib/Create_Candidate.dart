...
class createcandidatepage extends StatefulWidget {
  const createcandidatepage({Key? key, required this.ID}) : super(key: key);
  final String ID;

  @override
  State<createcandidatepage> createState() => createcandidatepageState();
}

class createcandidatepageState extends State<createcandidatepage> {

  // int flag=0;
  // String? id='';
  final candidatename=TextEditingController();
  final candidateparty=TextEditingController();
  final candidateposition=TextEditingController();
  String new_ID='';
  ...
  // }
  void dispose() {
    candidatename.dispose();
    candidateparty.dispose();
    candidateposition.dispose();
  }
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Center(
                child: Text(
                  "Add new Candidate details below.",
